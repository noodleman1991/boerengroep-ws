                                                    ...
                                                    <AnimatePresence>
                                                        {activeDropdown === item.label && (
                                                            <motion.div
                                                                ...
                                                                className="absolute top-full left-0 mt-1 w-56 bg-background/95 backdrop-blur-xl border border-border/50 rounded-lg shadow-lg shadow-black/5 overflow-hidden z-50"
                                                                onMouseEnter={() => setActiveDropdown(item.label!)}
                                                                onMouseLeave={() => setActiveDropdown(null)}
                                                            >
                    ...
                    <AnimatePresence>
                        {menuState && (
                            <motion.div
                                ...
                                className="bg-background/95 backdrop-blur-xl mb-6 w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-border/50 p-6 shadow-2xl shadow-zinc-300/10 md:flex-nowrap lg:hidden dark:shadow-none"
                            >
